        ...
        <Form>
          ...
          >
            <div className="w-full space-y-5">
              {/* NIN INPUT */}
              <Input name="nin" label="Document Type" placeholder="NIN number" />

              <CustomUpload
                name="profileImage"
                label="Upload a photo of your government issued ID"
              ...
              <div className="w-full bg-[#E0F4FD]  rounded-lg">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#212529]">Why we need your ID</span>
                  </div>
...
We need your ID to verify your identity and ensure the security of your account. Be rest assured that we do not have access to your bank details.
                  </div>
                )}
              </div>
            </div>
...
export default VerifyIdentityID;
