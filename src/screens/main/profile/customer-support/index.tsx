...
import { FiCheck, FiCopy, FiMail,  FiMic, FiPaperclip, FiPhone, FiSmile } from "react-icons/fi";
  ...
  return (
    <div className="flex items-center gap-4 rounded-xl border border-[#EEF3F6] bg-white p-4 shadow-sm">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-[14px] font-semibold text-[#20262D] truncate">{value}</p>
      </div>
      <button
        type="button"
        onClick={handleCopy}
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <InfoCard icon={FiPhone} label="Phone Number" value="+234 91 59894123" />
      </div>
