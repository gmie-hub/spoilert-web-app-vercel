...
const GetStarted = () => {
  ...
  return (
    ...
    // <section className="px-6 md:px-[100px] md:py-[72px]">
    //   {/* Peach background frame */}
    //   <div className="rounded-[8px] bg-[#F9D0B0] p-0 pt-4">
    //     <motion.div
    //       variants={containerVariants}
    //       initial="hidden"
    //       whileInView="visible"
    //       viewport={{ once: true }}
    //       className="relative overflow-hidden rounded-[12.8px] bg-[#053B4C] px-6  md:px-16 md:py-20 flex flex-col md:flex-row items-center gap-12"
    //     >
    //       {/* Left content */}
    //       <motion.div variants={itemVariants} className="flex-1 text-white">
    //         <h2 className="text-3xl md:text-5xl font-bold leading-tight">
